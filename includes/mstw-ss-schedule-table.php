...
function mstw_ss_schedule_table_shortcode_handler( $atts ){
	...
	return $output . mstw_ss_build_schedule_table( $attribs );
	
}

//--------------------------------------------------------------------------------------
// MSTW_SS_BUILD_SCHEDULE_TABLE
// 	Called by mstw_ss_table_shortcode_handler( )
...
// ARGUMENTS:
// 	$args - the display settings and shortcode arguments, properly combined by mstw_ss_shortcode_handler()
// RETURNS
//	HTML for schedule table as a string
//
	function mstw_ss_build_schedule_table( $args ) {
